...
# 학습 디렉토리 설정
train_dir = "/Users/yewon/Desktop/yongan"
attendance_file = "attendance.txt"

# KNN 모델 학습
train_data = TrainFaceData(train_dir, model_save_path=None, n_neighbors=None, knn_algo='ball_tree', verbose=False)
...
while True:
    ...
    if process_this_frame:
        ...
        face_locations, face_names = recognization.recognize_face(frame)
